...
hpssdir=${hpssdir:-/NCEPDEV/emc-da/2year/Brett.Hoover/HERA/scratch/ML_AMVs/datastore/Labels}    # Location of your file in HPSS
...
#
 htar -P -cvf ${hpssdir}/$tarfile ${YYYYMM}*/gdas.t*z.satwnd.tm00.bufr_d_*_labels_ERA5.nc
 err=$?
 if [ $err -ne 0 ]
   then
