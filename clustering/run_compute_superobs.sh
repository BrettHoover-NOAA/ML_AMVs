...
anaDateTime=${2}
anaHH=${3}
inputNetcdfFileName="gdas.t${anaHH}z.satwnd.tm00.bufr_d_${anaDateTime}_reconciled.nc"
outputNetcdfFileName="gdas.t${anaHH}z.satwnd.tm00.bufr_d_${anaDateTime}_superobs.nc"

python compute_superobs.py ${runDir} ${inputNetcdfFileName} ${outputNetcdfFileName}
