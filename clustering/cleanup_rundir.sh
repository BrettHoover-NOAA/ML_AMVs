...
# if a reconciled netCDF file was produced, delete any tiles
srcFile=${runDir}/${CDUMP}.t${anaHH}z.satwnd.tm00.bufr_d_${anaDateTime}_reconciled.nc
if [ -e "${srcFile}" ]; then
    ls -1 ${runDir}/${CDUMP}.t${anaHH}z.satwnd.tm00.bufr_d_${anaDateTime}_Tile*.nc >> rm_list.txt
fi
