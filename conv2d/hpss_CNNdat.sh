...
hpssdir=${hpssdir:-/NCEPDEV/emc-da/2year/Brett.Hoover/HERA/scratch/ML_AMVs/datastoreV2/CNNdat}    # Location of your file in HPSS
...
#
 htar -P -cvf ${hpssdir}/$tarfile ${YYYYMM}*/gdas.t*z.satwnd.tm00.bufr_d_*_superobs_CNN_T.nc.gz
 err=$?
 if [ $err -ne 0 ]
   then
