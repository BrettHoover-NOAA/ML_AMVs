...
if __name__ == "__main__":
    ...
    #lossFunc = torch.nn.MSELoss()  # v1.5
    lossFunc = torch.nn.HuberLoss(delta=10.)  # v1.5.1
    ...
    #optimizer = torch.optim.Adam(model.parameters(), lr=learningRate)  # v1.5
    optimizer = torch.optim.AdamW(model.parameters(), lr=learningRate, weight_decay=1.0E-02)  # v.1.5.1
