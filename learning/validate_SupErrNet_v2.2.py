...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(saveDir + userInputs.saveName + "E{:d}".format(epoch), map_location=torch.device('cpu')))  # map_location used to allow testing of CUDA models on CPU instead
