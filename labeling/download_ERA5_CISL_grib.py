...
def download_ERA5_CISL(dayTimeStamp):
    ...
    files = [
        "e5.oper.an.pl/" + dayTimeYYYYMM + "/e5.oper.an.pl.128_131_u.ll025uv." + dayTimeStamp + ".grb",
        "e5.oper.an.pl/" + dayTimeYYYYMM + "/e5.oper.an.pl.128_132_v.ll025uv." + dayTimeStamp + ".grb"
    ]
    ...
    for file in files:
        ...
        if (idx > 0):
            ...
            ofile = file
        response = requests.get("https://data.rda.ucar.edu/ds633.0/" + file)
