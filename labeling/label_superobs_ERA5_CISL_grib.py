...
#   hrMinus3GribHour: time-index for -3 hours in 24-hour hrMinus3GRIBFile (integer)
#   hrMinus2GRIBFile: full-path name of ERA5 GRIB file at -2 hours relative to analysis time (string)
#   hrMinus2GribHour: time-index for -2 hours in 24-hour hrMinus2GRIBFile (integer)
#   hrMinus1GRIBFile: full-path name of ERA5 GRIB file at -1 hours relative to analysis time (string)
#   hrMinus1GribHour: time-index for -1 hours in 24-hour hrMinus1GRIBFile (integer)
#   hrZeroGRIBFile: full-path name of ERA5 GRIB file at 0 hours relative to analysis time (string)
#   hrZeroGribHour: time-index for 0 hours in 24-hour hrZeroGRIBFile (integer)
#   hrPlus1GRIBFile: full-path name of ERA5 GRIB file at +1 hours relative to analysis time (string)
#   hrPlus1GribHour: time-index for +1 hours in 24-hour hrPlus1GRIBFile (integer)
#   hrPlus2GRIBFile: full-path name of ERA5 GRIB file at +2 hours relative to analysis time (string)
#   hrPlus23GribHour: time-index for +2 hours in 24-hour hrPlus2GRIBFile (integer)
#   hrPlus3GRIBFile: full-path name of ERA5 GRIB file at +3 hours relative to analysis time (string)
#   hrPlus3GribHour: time-index for +3 hours in 24-hour hrPlus3GRIBFile (integer)
#
# OUTPUTS:
...
# cfgrib
# os
def generate_ERA5_4dCube(varName, xCoordName, yCoordName, zCoordName, hrMinus3GRIBFile, hrMinus3GRIBHour,
                         hrMinus2GRIBFile,  hrMinus2GRIBHour, hrMinus1GRIBFile,  hrMinus1GRIBHour, hrZeroGRIBFile,
                         hrZeroGRIBHour, hrPlus1GRIBFile,  hrPlus1GRIBHour, hrPlus2GRIBFile,  hrPlus2GRIBHour,
                         hrPlus3GRIBFile, hrPlus3GRIBHour,):
    ...
    for t in range(nt):
        ...
        if tCoord[t] == -3.:
            ...
            gribHour = hrMinus3GRIBHour
        elif tCoord[t] == -2.:
            gribFile = hrMinus2GRIBFile
            gribHour = hrMinus2GRIBHour
        elif tCoord[t] == -1.:
            gribFile = hrMinus1GRIBFile
            gribHour = hrMinus1GRIBHour
        elif tCoord[t] == 0.:
            gribFile = hrZeroGRIBFile
            gribHour = hrZeroGRIBHour
        elif tCoord[t] == 1.:
            gribFile = hrPlus1GRIBFile
            gribHour = hrPlus1GRIBHour
        elif tCoord[t] == 2.:
            gribFile = hrPlus2GRIBFile
            gribHour = hrPlus2GRIBHour
        elif tCoord[t] == 3.:
            gribFile = hrPlus3GRIBFile
            gribHour = hrPlus3GRIBHour
        else:
...
if __name__ == "__main__":
    ...
    # define ERA5 daily GRIB files for each hour of observation-window, and define the time-index of the
    # hour in the daily GRIB file
    # minus 3 hours
    ...
    hrM3FileU = era5DataDir + 'e5.oper.an.pl.128_131_u.ll025uv.' + YYYY + MM + DD + '00_' + YYYY + MM + DD + '23.grb'
    hrM3FileV = era5DataDir + 'e5.oper.an.pl.128_132_v.ll025uv.' + YYYY + MM + DD + '00_' + YYYY + MM + DD + '23.grb'
    hrM3Hour = int(HH)
    # minus 2 hours
    ...
    DD = era5DateTime.strftime('%d')
    HH = era5DateTime.strftime('%H')
    hrM2FileU = era5DataDir + 'e5.oper.an.pl.128_131_u.ll025uv.' + YYYY + MM + DD + '00_' + YYYY + MM + DD + '23.grb'
    hrM2FileV = era5DataDir + 'e5.oper.an.pl.128_132_v.ll025uv.' + YYYY + MM + DD + '00_' + YYYY + MM + DD + '23.grb'
    hrM2Hour = int(HH)
    # minus 1 hours
    ...
    DD = era5DateTime.strftime('%d')
    HH = era5DateTime.strftime('%H')
    hrM1FileU = era5DataDir + 'e5.oper.an.pl.128_131_u.ll025uv.' + YYYY + MM + DD + '00_' + YYYY + MM + DD + '23.grb'
    hrM1FileV = era5DataDir + 'e5.oper.an.pl.128_132_v.ll025uv.' + YYYY + MM + DD + '00_' + YYYY + MM + DD + '23.grb'
    hrM1Hour = int(HH)
    ...
    DD = era5DateTime.strftime('%d')
    HH = era5DateTime.strftime('%H')
    hr00FileU = era5DataDir + 'e5.oper.an.pl.128_131_u.ll025uv.' + YYYY + MM + DD + '00_' + YYYY + MM + DD + '23.grb'
    hr00FileV = era5DataDir + 'e5.oper.an.pl.128_132_v.ll025uv.' + YYYY + MM + DD + '00_' + YYYY + MM + DD + '23.grb'
    hr00Hour = int(HH)
    # plus 1 hours
    era5DateTime = anaDateTime + datetime.timedelta(hours=1)
    YYYY = era5DateTime.strftime('%Y')
    ...
    DD = era5DateTime.strftime('%d')
    HH = era5DateTime.strftime('%H')
    hrP1FileU = era5DataDir + 'e5.oper.an.pl.128_131_u.ll025uv.' + YYYY + MM + DD + '00_' + YYYY + MM + DD + '23.grb'
    hrP1FileV = era5DataDir + 'e5.oper.an.pl.128_132_v.ll025uv.' + YYYY + MM + DD + '00_' + YYYY + MM + DD + '23.grb'
    hrP1Hour = int(HH)
    # plus 2 hours
    era5DateTime = anaDateTime + datetime.timedelta(hours=2)
    YYYY = era5DateTime.strftime('%Y')
    ...
    DD = era5DateTime.strftime('%d')
    HH = era5DateTime.strftime('%H')
    hrP2FileU = era5DataDir + 'e5.oper.an.pl.128_131_u.ll025uv.' + YYYY + MM + DD + '00_' + YYYY + MM + DD + '23.grb'
    hrP2FileV = era5DataDir + 'e5.oper.an.pl.128_132_v.ll025uv.' + YYYY + MM + DD + '00_' + YYYY + MM + DD + '23.grb'
    hrP2Hour = int(HH)
    # plus 3 hours
    era5DateTime = anaDateTime + datetime.timedelta(hours=3)
    YYYY = era5DateTime.strftime('%Y')
    ...
    DD = era5DateTime.strftime('%d')
    HH = era5DateTime.strftime('%H')
    hrP3FileU = era5DataDir + 'e5.oper.an.pl.128_131_u.ll025uv.' + YYYY + MM + DD + '00_' + YYYY + MM + DD + '23.grb'
    hrP3FileV = era5DataDir + 'e5.oper.an.pl.128_132_v.ll025uv.' + YYYY + MM + DD + '00_' + YYYY + MM + DD + '23.grb'
    hrP3Hour = int(HH)
    ...
    zCoord, yCoord, xCoord, tCoord, um = generate_ERA5_4dCube('u', 'longitude', 'latitude', 'isobaricInhPa', hrM3FileU, hrM3Hour,
                                                              hrM2FileU, hrM2Hour, hrM1FileU, hrM1Hour, hr00FileU, hr00Hour, hrP1FileU,
                                                              hrP1Hour, hrP2FileU, hrP2Hour, hrP3FileU, hrP3Hour)
    vm = generate_ERA5_4dCube('v', 'longitude', 'latitude', 'isobaricInhPa', hrM3FileV, hrM3Hour, hrM2FileV, hrM2Hour, hrM1FileV,
